...
#this function provides a universally unique identifier

print (uuid.uuid4()) 


#these are instructions for our API request and how it's going to access Nicehash


#this is a setup for hashing the instructions for our apirequest

print ("X-Auth")
requestid= 'GET'
requestpath= '/main/api/v2/mining/rigs2/' 
